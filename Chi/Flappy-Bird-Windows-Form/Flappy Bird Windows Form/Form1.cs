...
namespace Flappy_Bird_Windows_Form
{
    public partial class Form1 : Form
    {
        ...
        // Sửa constructor để nhận tham số
        public Form1(string selectedCharacter, string difficulty)
        {
            InitializeComponent();
...
static void Main()
{
    ...
    Application.Run(new MainMenu()); // This will start the MainMenu form
}
    ...
    public partial class Form1 : Form
    {
        ...
        private void endGame()
        {
            ...
            scoreText.Text += " Game over!!! Press R to Restart"; // show the game over text on the score text, += is used to add the new string of text next to the score instead of overriding it
            gameOver = true;
        }
